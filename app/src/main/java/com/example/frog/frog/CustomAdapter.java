...
public class CustomAdapter extends ArrayAdapter<EmpList> {
    ...
    public CustomAdapter(ArrayList<EmpList> data, Context context) {
        super(context, R.layout.employment_layout, data);
        this.dataSet = data;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        //아이템을 받아옵니다
        final EmpList dataModel = getItem(position);
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.employment_list, parent, false);
        ...
        convertView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                EmpInfo.putExtra("empID", dataModel.getID());
